...
class htmlclass {
    ...
    private function drawMainFormBody($buttonText,$isThread=false){
        ...
        <table>
        <tr>
            <td class="accent"><label for="name"><b>Name</b></label></td>
        ...
        <tr>
            <td class="accent"><label for="email"><b>Email</b></label></td>
            <td>
        ...
        <tr>
            <td class="accent"><label for="subject"><b>Subject</b></label></td>
        ...
        <tr>
            <td class="accent"><label for="comment"><b>Comment</b></label></td>
        ...
        <tr>
            <td class="accent"><label for="files"><b>Files</b></label></td>
        ...
        if($AUTH->isAuth($board->getBoardID()) && ! $AUTH->isJanitor($board->getBoardID())){
            $this->html .= '
            <tr>
                <td class="accent"><label for="stripHTML"><b>Strip HTML</b></label></td>
